...
describe('FirstContract', () => {
    ...
    beforeEach(async () => {
        ...
        firstContract = blockchain.openContract(await FirstContract.fromInit(9022513040n));
    ...
    it('should increase', async () => {
        ...
        console.log("Counter B4 ", counterBefore);
        ...
        console.log("Counter AFT ", counterAfter);
